// // MediaShareOverlay.jsx
// // Route: /overlay/:token/media
// // Pasang di OBS sebagai Browser Source (480x320 atau lebih)
// // OBS: centang "Allow transparency" di Browser Source
...
//       // ← Perbedaan utama vs OverlayAlert: skip kalau tidak ada media
...
//   const maxW        = Math.max(config.maxWidth || 340, 400); // min 400 karena ada media
...
//                 <div style={{ fontSize: 9, fontWeight: 800, opacity: 0.65, textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: 4, color: fg }}>
//                   🎬 Media Share
//                 </div>
...
//             {renderMedia()}
//             <div style={{ fontSize: 9, fontWeight: 700, opacity: 0.6, textTransform: 'uppercase', letterSpacing: '0.08em', marginBottom: 8, color: fg, display: 'flex', alignItems: 'center', gap: 6 }}>
...
//               Rp {Number(alert.amount).toLocaleString('id-ID')}
//             </div>
//             <div style={{ color: fg, fontSize: 16, fontWeight: 700, marginTop: 3 }}>
//               @{alert.donorName}
//             </div>
//             {alert.message && (
...
// MediaShareOverlay.jsx
// Route: /overlay/:token/media
// OBS: centang "Allow transparency" di Browser Source, ukuran 600x500px
