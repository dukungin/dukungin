  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isLogin) {
        ...
        // Register sukses → notif → pindah ke login
          ...
          <>
            ...
            >
              <div className="bg-white rounded-[3rem] p-10 shadow-2xl text-center">
                ...
                <h3 className="text-3xl font-black text-slate-800 mb-3">{notification.title}</h3>
          ...
          {isForgot ? (
            <>
              ...
              <button 
                ...
                className="cursor-pointer active:scale-[0.97] mt-4 w-full bg-indigo-600 text-white py-4 rounded-2xl font-black text-lg hover:bg-indigo-700 transition-all flex items-center justify-center gap-3 shadow-xl shadow-indigo-100 disabled:opacity-70"
              >
                {loading ? (
              ...
              <button 
                ...
                className="text-md underline text-indigo-500 hover:text-indigo-600 mt-6 cursor-pointer active:scale-[0.97]"
              >
                Kembali ke login
              </button>
            </>
