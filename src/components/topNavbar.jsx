...
import { AlertCircle, ChevronRight, HeadphonesIcon, LogOut, Moon, Sun, Users, Wallet } from "lucide-react";
...
export const TopNavbar = ({ user, onLogout, onProfile, activeTab, setActiveTab, navbar }) => {
  ...
  return (
    <>
      <div className={`sticky top-0 ${navbar ? 'z-[1]' : 'z-[3]'} w-full bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-100 dark:border-slate-800 px-6 py-4 flex items-center justify-between gap-4`}>
